...
// READ - Retrieve all participants
...
// READ - Retrieve a specific participant
...
router.post('/', (req, res, next) => {
  ...
  db.run(sql, [first_name, last_name, email], function(err) {
    if (err) {
      // Handle email uniqueness error (unique=True constraint in Django)
